...
public class BlueSideLaunchAuto extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        if (opModeIsActive()) {
            ...
            // Step 2: Turn to face the goal (BLUE turns RIGHT/Positive)
            ...
            // Step 4: Turn to face away from the goal (BLUE turns LEFT/Negative)
            ...
            // Step 6: Park Turn (BLUE turns LEFT/Negative)
